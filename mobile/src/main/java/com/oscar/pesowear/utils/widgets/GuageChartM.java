...
public class GuageChartM extends View{
    ...
    public GuageChartM(Context context, AttributeSet attributeSet){
    ...
    protected void onDraw(Canvas canvas){
        ...
        if (data != null){
            ...
            for (int i = 0; i < segment.length; i++){
                ...
                if(i == 0){
                    canvas.drawText("Muy bien", arcCenterX - 210 - text_width, arcCenterY , textPaint);
                }

                if(i == segment.length - 1){
                    canvas.drawText("Excelente", arcCenterX + 210 + 10, arcCenterY , textPaint);
                }
